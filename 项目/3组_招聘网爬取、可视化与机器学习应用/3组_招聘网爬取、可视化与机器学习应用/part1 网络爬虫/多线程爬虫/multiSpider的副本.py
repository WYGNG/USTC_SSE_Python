...
class ParseSpider(threading.Thread):
    ...
    def run(self):
        # print("启动" + self.threadName)
        global itemQueue, exitFlag_Parse, urlQueue
...
def main():
    ...
    # 初始化采集url线程
    threadUrls = []
    urlSpiderList = ["urlThread1", "urlThread2", "urlThread3", "urlThread4", "urlThread5", "urlThread6", "urlThread7", "urlThread8"]
    ...
    # 初始化存储线程
    threadSave = []
    saveSpiderList = ["saveThread1", "saveThread2", "saveThread3", "saveThread4", "saveThread5"]
